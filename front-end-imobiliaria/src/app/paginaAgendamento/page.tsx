                    ...
                    <div>
                        ...
                        <div className="flex flex-col md:flex-row justify-between pb-36 lg:pb-40 xl:pb-44 2xl:pb-56">
                            ...
                            <div className="pt-11 sm:pt-14 md:pt-20 lg:pt-28 sm:px-1 md:px-5 lg:px-10">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center gap-4 mt-6">
                                    ...
                                    <button
                                        type="submit"
                                        className="bg-[#702632] p-3 px-10 lg:p-3 lg:px-10 xl:p-3 xl:px-14 2xl:p-5 2xl:px-14 rounded-[20px]"
                                    >
