...
export default function HistoryCalendar({ locale = "pt-BR", className, onDateChange }: HistoryCalendarProps) {
      ...
      days.push(
        <div key={`prev-${day}`} className="flex justify-center items-center py-2">
          <button
            ...
            className={cn(
              "flex justify-center items-center w-8 h-8 rounded-lg text-gray-300 font-medium transition-all hover:bg-gray-100"
            )}
          >
            {day}
          </button>
