  ...
  return (
    <div className="font-montserrat flex h-screen items-center justify-center bg-gray-100">
      <div className="shadow-md rounded-lg flex flex-col md:flex-row w-4/5 max-w-5xl bg-[#EBE8DE]">
        {/* Lado Esquerdo */}
        <div className="w-full md:w-[40%] flex flex-col py-20 items-center justify-center bg-gradient-to-b from-[rgba(223,218,208,1)] to-[rgba(115,115,115,0.3)] rounded-l-lg">
